    ...
    props.showModal(
      {
        open: true,
        message:
          "Dăng xuất khỏi thiết bị sẽ xoá mọi cuốn sách đã tải xuống, bạn có chấp nhận không?",
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.tabLabel}>Sách của bạn</Text>
        <IconFeather
          style={{ left: 10 }}
          name={"chevron-right"}
          color={"#A9A9A9"}
      ...
      >
        ...
        <Text style={styles.tabLabel}>Lịch sử đọc</Text>
        <IconFeather
          style={{ left: 10 }}
          name={"chevron-right"}
          color={"#A9A9A9"}
      ...
      {props.haveChapterDownload && (
        ...
        >
          ...
          <Text style={styles.tabLabel}>Tải xuống</Text>
          <IconFeather
            style={{ left: 10 }}
            name={"chevron-right"}
            color={"#A9A9A9"}
      ...
      <TouchableOpacity style={styles.tabWrapper} onPress={this.signOut}>
        ...
        <Text style={styles.tabLabel}>Đăng xuất</Text>
        <IconFeather
          style={{ left: 10 }}
          name={"chevron-right"}
          color={"#A9A9A9"}
