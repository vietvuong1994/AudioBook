        ...
        <View style={styles.content}>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ marginLeft: 7 }}>
              <Text style={styles.titleText}>Số chương {numberOfChapter}</Text>
              <Text style={styles.normal}>Thời lượng {duration}</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ marginLeft: 7 }}>
              <Text style={styles.titleText}>
                Hoàn thành {numberChapterDone}
              </Text>
              <Text style={styles.normal}>Còn {timeLeftText}</Text>
            </View>
          </View>
        </View>
      </View>
      <Text style={styles.chapters}>Chương</Text>
    </View>
  );
};
